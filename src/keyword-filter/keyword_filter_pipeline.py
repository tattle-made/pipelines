...
class SourceData(luigi.Task):
    ...
    def run(self):
        try:
            ...
            logger.info("Problem sourcing data")
...
class ExtractText(luigi.Task):
    ...
    def run(self):
        try:
            ...
            logger.info("Problem extracting text")
            logger.info(logging.traceback.format_exc())
            pass
...
class TranslateText(luigi.Task):
    ...
    def run(self):
        ...
        try:
            ...
            logger.info("Problem translating text")
            logger.info(logging.traceback.format_exc())
            pass
...
class FilterText(luigi.Task):
    ...
    def run(self):
        try:
            ...
            logger.info("Problem filtering text")
            logger.info(logging.traceback.format_exc())
            pass
...
class StoreExtraction(luigi.Task):
    ...
    def run(self):
        try:
            ...
            logger.info("Problem storing extracted text")
            logger.info(logging.traceback.format_exc())
            pass
...
class StoreTranslation(luigi.Task):
    ...
    def run(self):
        try:
            ...
            logger.info("Problem storing translated text")
            logger.info(logging.traceback.format_exc())
            pass
...
class StoreLabel(luigi.Task):
    ...
    def run(self):
        try:
            ...
            logger.info("Problem storing label")
            logger.info(logging.traceback.format_exc())
            pass
